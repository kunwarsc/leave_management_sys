...
def apply_leave(request):
    error = ''
    msg = ''
    date_difference = None  # Initialize date_difference
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # Ensure both fromdate and todate are filled before calculating date difference
    ...
    context = {
        ...
        'error': error,
        'msg': msg,
        'date_difference': date_difference,  # Pass the date difference to the template
    }
